...
#ifdef DEF_GET_PRCM_AHB_GAT1_VDC
def_get_mod_reg_bit(prcm, ahb_gat1, vdc, addr);
#endif

#ifdef DEF_GET_PRCM_AHB_GAT1_VC
def_get_mod_reg_bit(prcm, ahb_gat1, vc, addr);
#endif
...
#ifdef DEF_GET_PRCM_AHB_RST1_VDC
def_get_mod_reg_bit(prcm, ahb_rst1, vdc, addr);
#endif

#ifdef DEF_GET_PRCM_AHB_RST1_VC
def_get_mod_reg_bit(prcm, ahb_rst1, vc, addr);
#endif
...
#ifdef DEF_GET_PRCM_AXI_GAT_VC
def_get_mod_reg_bit(prcm, axi_gat, vc, addr);
#endif

#ifdef DEF_GET_PRCM_AXI_GAT_VDC
def_get_mod_reg_bit(prcm, axi_gat, vdc, addr);
#endif
...
#ifdef DEF_GET_PRCM_PLL_DBG_DLOCK_EN
def_get_mod_reg_bit(prcm, pll_dbg, dlock_en, addr);
#endif

#ifdef DEF_GET_PRCM_PLL_DBG_LOCK_FAC_DET_EN
def_get_mod_reg_bit(prcm, pll_dbg, lock_fac_det_en, addr);
#endif
...
#ifdef DEF_GET_PRCM_SDRAM_RST_X4CLK_RST
def_get_mod_reg_bit(prcm, sdram_rst, x4clk_rst, addr);
#endif
...
#ifdef DEF_GET_PRCM_VC_CLK_CTRL_SRC_SEL
def_get_mod_reg_bit(prcm, vc_clk_ctrl, src_sel, addr);
#endif

#ifdef DEF_GET_PRCM_VC_CLK_CTRL_DIV0
def_get_mod_reg_bit(prcm, vc_clk_ctrl, div0, addr);
#endif

#ifdef DEF_GET_PRCM_VC_CLK_CTRL_EN
def_get_mod_reg_bit(prcm, vc_clk_ctrl, en, addr);
#endif

#ifdef DEF_GET_PRCM_VDC_CLK_CTRL_SRC_SEL
def_get_mod_reg_bit(prcm, vdc_clk_ctrl, src_sel, addr);
#endif

#ifdef DEF_GET_PRCM_VDC_CLK_CTRL_DIV0
def_get_mod_reg_bit(prcm, vdc_clk_ctrl, div0, addr);
#endif

#ifdef DEF_GET_PRCM_VDC_CLK_CTRL_EN
def_get_mod_reg_bit(prcm, vdc_clk_ctrl, en, addr);
#endif
...
#ifdef DEF_GET_PRCM_DOSS_CLK_CTRL_SCLK0_SRC
def_get_mod_reg_bit(prcm, doss_clk_ctrl, sclk0_src, addr);
#endif

#ifdef DEF_GET_PRCM_DOSS_CLK_CTRL_SCLK0_DIV
def_get_mod_reg_bit(prcm, doss_clk_ctrl, sclk0_div, addr);
#endif
