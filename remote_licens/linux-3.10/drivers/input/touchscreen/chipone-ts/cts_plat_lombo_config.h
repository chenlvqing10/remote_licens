#ifndef CTS_PLAT_LOMBO_CONFIG_H
#define CTS_PLAT_LOMBO_CONFIG_H

#define CONFIG_CTS_PM_FB_NOTIFIER
#ifdef CONFIG_DRM_LOMBO
/* #define CFG_CTS_DRM_NOTIFIER */
#endif/*CONFIG_DRM_LOMBO*/
...
#if !defined(CONFIG_CTS_PM_GENERIC) #define CONFIG_CTS_PM_LEGACY
#endif
#endif
