 ...
 */
#define LVDS_MODE	(TCON_LVDS_JEIDA)
...
/* lvds 1024x600 LCD test */
static const struct drm_display_mode wks_wks70002_mode = {
	/* dclk_freq */
	.clock = 66000000,
	/* width */
	.hdisplay = 1024,
...
static const struct panel_desc wks_wks70002 = {
	.modes = &wks_wks70002_mode,
	.num_modes = 1,
	.bpc = 6,
	.size = {
		.width = 1024,
