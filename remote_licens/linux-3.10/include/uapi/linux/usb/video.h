...
#define UVC_DT_STILL_IMAGE_FRAME_SIZE(n, p)			(10+(4*n)-4+p)

#define UVC_STILL_IMAGE_FRAME_DESCRIPTOR(n, p) \
	uvc_still_image_frame_descriptor_##n_##p

#define DECLARE_UVC_STILL_IMAGE_FRAME_DESCRIPTOR(n, p)	\
struct UVC_STILL_IMAGE_FRAME_DESCRIPTOR(n, p) {		\
	__u8  bLength;					\
	__u8  bDescriptorType;				\
	__u8  bDescriptorSubType;			\
	__u8  bEndpointAddress;				\
	__u8  bNumImageSizePatterns;			\
	__u16 wWidth_wHeight[n][2];			\
