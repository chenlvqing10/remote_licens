 ...
 *        for atomic kms begining, this prevent dbreg from loading.
...
/**
 * struct drm_lombo_palette_header - header of lombo_palette.
 * @version: version of struct drm_lombo_palette_header.
 * @color_table_offset: color_table's offset from the beginning of this header.
 * @color_table_size: size of color_table, in byte.
 * @data_offset: data's offset from the beginning of this header.
 * @data_size: size of data, in byte.
 * @pixel_order: reserved. no used at present.
 */
struct drm_lombo_palette_header {
	uint32_t version;
