#ifndef __ONVIF_SUBSCRIBE_H__
#define __ONVIF_SUBSCRIBE_H__
...
#define HI_MD_ALARM_HAPPEN 0
#define HI_MD_ALARM_DISAPP 1
#define HI_DI_ALARM_HAPPEN 2
#define HI_DI_ALARM_DISAPP 3
typedef struct {
	unsigned int u32AlarmType;
} HI_ALARM_INFO_S, *LPHI_ALARM_INFO_S;
