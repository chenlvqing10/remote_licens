...
#define MANUFACTURER_NAME "IPC"
#define MODEL_NAME "ONVIF"
...
{
	/* required attribute of type tt:ReferenceToken */
	char* token;
	/* required element of type xsd:float */
	float Framerate;
	/* required element of type tt:VideoResolution */
...
typedef struct _HI_ONVIF_AUDIO_SOURCE_S_
{
	/* required attribute of type tt:ReferenceToken */
	char* token;
	/* required element of type xsd:int */
	int Channels;
} HI_ONVIF_AUDIO_SOURCE_S;

typedef struct _HI_ONVIF_PROFILE_S_
{
	/* required element of type tt:Name */
	char* Name;
	/* required attribute of type tt:ReferenceToken */
	char* token;
	/* optional attribute of type xsd:boolean */
	int fixed;
...
typedef struct _HI_ONVIF_VIDEO_SOURCE_CFG_S_
{
	...
	/* required attribute of type tt:ReferenceToken */
	char* token;
	/* required element of type tt:ReferenceToken */
	char* SourceToken;
	/* required element of type tt:IntRectangle */
...
typedef struct _HI_ONVIF_VIDEO_ENCODER_CFG_S_
{
	...
	/* required attribute of type tt:ReferenceToken */
	char *token;
	/* required element of type tt:VideoEncoding */
	...
	int FrameRate;
	int Bitrate;
	/*Ecoder Format:0--h264 1--MJPEG 2--JPEG 3--MPEG4 4--h265*/
	int AdvanceEncType;
...
typedef struct _HI_ONVIF_AUDIO_ENCODER_CFG_S_
{
	...
	/* required attribute of type tt:ReferenceToken */
	char* token;
	/* required element of type tt:AudioEncoding */
...
typedef struct _HI_ONVIF_INFO_S_
{
	...
	/* optional element of type tt:VideoSourceConfiguration */
	HI_ONVIF_VIDEO_SOURCE_CFG_S
		OnvifVideoSourceCfg[ONVIF_VIDEO_SOURCE_CFG_NUM];
	/* optional element of type tt:AudioSourceConfiguration */
	HI_ONVIF_AUDIO_SOURCE_CFG_S
		OnvifAudioSourceCfg[ONVIF_AUDIO_SOURCE_CFG_NUM];
	/* optional element of type tt:VideoEncoderConfiguration */
	HI_ONVIF_VIDEO_ENCODER_CFG_S
		OnvifVideoEncoderCfg[ONVIF_VIDEO_ENCODER_CFG_NUM];
	/* optional element of type tt:AudioEncoderConfiguration */
	HI_ONVIF_AUDIO_ENCODER_CFG_S
		OnvifAudioEncoderCfg[ONVIF_AUDIO_ENCODER_CFG_NUM];
