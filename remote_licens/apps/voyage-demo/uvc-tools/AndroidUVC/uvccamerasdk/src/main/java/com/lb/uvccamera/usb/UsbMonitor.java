...
public class UsbMonitor implements IMonitor {
    ...
    public UsbMonitor(Context context, CameraConfig config) {
        ...
        LogUtil.i("get mUsbManager is " + mUsbManager.toString());
    }
    ...
    public void checkDevice() {
        ...
        LogUtil.i("checkDevice: usbDevice:" + usbDevice);
    ...
    public void connectDevice(UsbDevice usbDevice) {
        LogUtil.i("connectDevice-->" + usbDevice.getDeviceName());
    ...
    private class USBReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            LogUtil.i("usbDevice-->" + usbDevice.getDeviceName());
