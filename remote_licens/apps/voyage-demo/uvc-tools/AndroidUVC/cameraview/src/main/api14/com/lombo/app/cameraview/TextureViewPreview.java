...
//                setSize(1920, 1080);
    ...
    void configureTransform() {
        ...
        // lombo: change pixel
        float winWidth = this.getWidth();
        float winHeight = this.getHeight();
        Log.w(TAG,"configureTransform: winWidth: "+winWidth+"--"+winHeight);
        RectF previewRect = new RectF(0, 0, winWidth, winHeight);
        RectF surfaceDimensions;
        surfaceDimensions = new RectF(0, 0, winWidth, (float)(winWidth/1.78));
