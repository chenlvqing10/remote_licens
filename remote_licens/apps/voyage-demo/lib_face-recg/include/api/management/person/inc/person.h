...
typedef enum {
	...
	PERSON_REGISTRATION_ERROR,	/* Repeated registration name error */
...
/** Failed error code when unregister person information */
typedef enum {
	PERSON_UNREG_OK = 0,		/* OK */
	PERSON_HAVE_NOT,    /*  */
	PERSON_UNREG_FAIL,
} e_person_unreg_code;
...
/**
 * person_get_feats_from_data – Get face features from face picture (jpeg) data.
