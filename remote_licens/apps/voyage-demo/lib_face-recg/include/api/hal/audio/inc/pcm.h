...
enum pcm_param {
	 ...
	 */
	PCM_PARAM_ACCESS,
	/** A mask that represents the @ref pcm_format available
	 *(e.g. @ref PCM_FORMAT_S32_LE)
	 */
	PCM_PARAM_FORMAT,
	/** A mask that represents the subformat available */
	PCM_PARAM_SUBFORMAT,
	/** An interval representing the range of sample bits available
	 *(e.g. 8 to 32)
	 */
	PCM_PARAM_SAMPLE_BITS,
	/** An interval representing the range of frame bits available
	 *(e.g. 8 to 64)
	 */
	PCM_PARAM_FRAME_BITS,
	/** An interval representing the range of channels available
	 *(e.g. 1 to 2)
	 */
	PCM_PARAM_CHANNELS,
	/** An interval representing the range of rates available
	 *(e.g. 44100 to 192000)
	 */
	PCM_PARAM_RATE,
