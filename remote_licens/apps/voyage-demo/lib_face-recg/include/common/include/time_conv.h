 ...
 */
int time_str_to_second(const char *str_time, long *out_sec);
 ...
 * @return 0-successful; -1-failed
 */
int time_get_cur_time_ret_tm(struct tm *cur_tm);
 ...
 * Returns 0 if success, otherwise not 0.
 */
double get_after_n_day_timestamp(double *t, int nday);
