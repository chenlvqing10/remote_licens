...
#include "ADTSAudioServerMediaSubsession.hh"

extern "C" int rtsp_server_init();
extern "C" void rtsp_server_deinit();
char watchVariable;

void *rtsp_server_task(void *p)
{
...
#ifdef RTSP_AUDIO
	sms->addSubsession(new ADTSAudioServerMediaSubsession(*env));
#endif
