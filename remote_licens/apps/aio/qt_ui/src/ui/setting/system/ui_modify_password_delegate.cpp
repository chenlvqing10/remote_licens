/*
* ui_modify_password_delegate.cpp -
...
ui_modify_password_delegate::
ui_modify_password_delegate(QObject *parent) : QStyledItemDelegate(parent) {
}

void ui_modify_password_delegate::paint(
    QPainter *painter,
  ...
  if (index.isValid()) {
    ...
    MuItemData_password itemData = var.value<MuItemData_password>();
    ...
    QRectF nameRect = QRect(
      rect.left() + ICON_BACK_AMAGE, rect.top() + 18, 500, 62);
...
QSize ui_modify_password_delegate::sizeHint(
