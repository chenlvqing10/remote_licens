 ...
 * PIXEL_ALPHA: Using the per-plane alpha.
 ...
 * @is_premul: color data is premul alpha.
...
#define DRM_LOMBO_MODE_SETPLANE 0x07
...
/**
 * lombo mode set/disable plane.
 */
#define DRM_IOCTL_LOMBO_MODE_SETPLANE DRM_IOWR(DRM_COMMAND_BASE +	\
		DRM_LOMBO_MODE_SETPLANE, struct drm_lombo_mode_set_plane)
