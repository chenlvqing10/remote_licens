...
LOCAL_SHARED_LIBRARIES := liblog  libomx libalc liblombo_malloc

LOCAL_STATIC_LIBRARIES := libtsmuxer

include $(BUILD_SHARED_LIBRARY)

-include $(LOCAL_PATH)/tsmuxer/Virgo.mk
