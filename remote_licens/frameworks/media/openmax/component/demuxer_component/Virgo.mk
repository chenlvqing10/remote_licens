...
LOCAL_SRC_FILES += \
	../vdec_component/vdec_lib_handle.c \
	../adec_component/adec_lib_handle.c
LOCAL_C_INCLUDES += \
	../vdec_component \
	../adec_component

LOCAL_MODULE:= libomx_demuxer
...
LOCAL_SHARED_LIBRARIES := liblog libomx libiostream
#LOCAL_ADDITIONAL_DEPENDENCIES := libiostream
