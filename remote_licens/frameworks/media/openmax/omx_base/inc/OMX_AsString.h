...
inline static const char *asString(OMX_AUDIO_AACPROFILETYPE i, const char *def = "??")
{
	...
	case OMX_AUDIO_AACObjectScalable:
		return "Scalable";
	case OMX_AUDIO_AACObjectER_Scalable:
		return "ER_Scalable";
...
inline static const char *asString(OMX_AUDIO_AACSTREAMFORMATTYPE i,
	const char *def = "??")
{
	switch (i) {
...
inline static const char *asString(OMX_AUDIO_AMRFRAMEFORMATTYPE i,
	const char *def = "??")
{
	switch (i) {
...
//      case OMX_IndexConfigCommit:                     return "ConfigCommit";
	case OMX_IndexConfigAndroidVendorExtension:
		return "ConfigAndroidVendorExtension";
	...
	case OMX_IndexParamAudioAndroidEac3:
		return "ParamAudioAndroidEac3";
	case OMX_IndexParamAudioProfileQuerySupported:
		return "ParamAudioProfileQuerySupported";
...
//      case OMX_IndexParamSliceSegments:               return "ParamSliceSegments";
	...
	case OMX_IndexParamAndroidVideoTemporalLayering:
		return "ParamAndroidVideoTemporalLayering";
	case OMX_IndexConfigAndroidVideoTemporalLayering:
		return "ConfigAndroidVideoTemporalLayering";
	...
	case OMX_IndexParamVideoVp9:
		return "ParamVideoVp9";
	case OMX_IndexParamVideoAndroidVp9Encoder:
		return "ParamVideoAndroidVp9Encoder";
...
inline static const char *asString(OMX_VIDEO_AVCPROFILEEXTTYPE i, const char *def = "??")
{
	...
	default:
		return asString((OMX_VIDEO_AVCPROFILETYPE)i, def);
	}
}
...
{
	switch (i) {
	case OMX_VIDEO_AndroidTemporalLayeringPatternNone:
		return "None";
	case OMX_VIDEO_AndroidTemporalLayeringPatternWebRTC:
		return "WebRTC";
	case OMX_VIDEO_AndroidTemporalLayeringPatternAndroid:
		return "Android";
	default:
		return def;
	}
